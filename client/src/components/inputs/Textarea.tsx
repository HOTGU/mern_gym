  ...
  return (
    <div className={cls("relative w-full")}>
      ...
      <div
        ...
        className={cls(
          "absolute origin-[0] font-bold left-4 text-xs scale-100 text-neutral-400 peer-placeholder-shown:scale-100 peer-focus:text-neutral-700 peer-focus:scale-105 peer-disabled:cursor-not-allowed cursor-text transition",
          small ? "top-1" : "top-2 "
        )}
      >
        {label}
